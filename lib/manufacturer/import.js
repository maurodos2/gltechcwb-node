...
function extrairModelo(produto) {
  ...
  // Intel: processadores (ex.: I3-12100, I5-12400F → i3-12100, i5-12400f)
  const mIntel = nome.match(/\bi\d-?\d{4,5}[a-z]?\b/i);
  if (mIntel) return mIntel[0].toLowerCase();
  return '';
}
